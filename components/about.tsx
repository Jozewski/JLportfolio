...
export const TechIcons = {
  React: () => (
    <svg
      className="h-5 w-5 transition-transform duration-300 hover:scale-110 text-[#61DAFB] dark:text-[#1e90ff]"
      viewBox="0 0 24 24"
      fill="currentColor"
    >
  ...
  GitHub: () => (
    <svg
      className="h-5 w-5 transition-transform duration-300 hover:scale-110 text-[#181717] dark:text-gray-200"
      viewBox="0 0 24 24"
      fill="currentColor"
    >
  ...
  Vercel: () => (
    <svg
      className="h-5 w-5 transition-transform duration-300 hover:scale-110 text-black dark:text-gray-200"
      viewBox="0 0 24 24"
      fill="currentColor"
    >
  ...
  Mongoose: () => (
    <Database className="h-5 w-5 text-[#880000] transition-transform duration-300 hover:scale-110" />
  ),
  JWT: () => (
    <Code className="h-5 w-5 text-[#000000] transition-transform duration-300 hover:scale-110" />
  ),
  Axios: () => (
    <Globe className="h-5 w-5 text-[#5A29E4] transition-transform duration-300 hover:scale-110" />
  ),
  Passport: () => (
    <Code className="h-5 w-5 text-[#34E27A] transition-transform duration-300 hover:scale-110" />
  ),
  Mobile: () => (
    <Smartphone className="h-5 w-5 text-[#61DAFB] transition-transform duration-300 hover:scale-110" />
  ),
};
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Crafting innovative solutions with a focus on user experience and
            community impact
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              My coding journey began in 2014, when I started building GUI
              interfaces and programming solutions using technologies like C++
              and JavaScript. Early on, I focused on creating intuitive user
              experiences for digital platforms and contributed to the rollout
              of tablet applications designed to streamline content delivery.
              That hands-on exposure to both front-end design and technical
              implementation sparked my passion for clean, user-centered
              development and laid the groundwork for everything I have pursued
              since.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              As technology evolved rapidly, I recognized the need to modernize
              my skillset and embarked on a new adventure in 2024, diving deep
              into modern web development with React, Node.js, and full-stack
              technologies. This journey has allowed me to combine my
              foundational programming experience with cutting-edge frameworks
              to build applications that truly make a difference.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              What drives me is the sheer joy of seeing something I built
              actually work and make a difference. I specialize in creating
              applications that help communities and organizations - from
              non-profit project trackers to real-time communication platforms.
              Every project teaches me something new about the endless
