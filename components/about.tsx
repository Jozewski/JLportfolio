...
export const TechIcons = {
  React: () => (
    <svg className="h-5 w-5 transition-transform duration-300 hover:scale-110" viewBox="0 0 24 24" fill="#61DAFB">
  ...
  GitHub: () => (
    <svg className="h-5 w-5 transition-transform duration-300 hover:scale-110" viewBox="0 0 24 24" fill="#181717">
  ...
  Vercel: () => (
    <svg className="h-5 w-5 transition-transform duration-300 hover:scale-110" viewBox="0 0 24 24" fill="#000000">
  ...
  SocketIO: () => (
    <svg className="h-5 w-5 transition-transform duration-300 hover:scale-110" viewBox="0 0 24 24" fill="#010101">
